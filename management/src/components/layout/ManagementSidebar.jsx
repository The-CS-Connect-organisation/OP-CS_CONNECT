...
const ROLE_NAV = {
  ...
  teacher: [
    ...
    },
    {
      section: 'Academic',
      items: [
        { title: 'Assignments', icon: ClipboardList, route: '/teacher/assignments' },
        { title: 'Attendance', icon: Users, route: '/teacher/attendance' },
        { title: 'Grading', icon: ClipboardList, route: '/teacher/grading' },
        { title: 'Upload Notes', icon: Megaphone, route: '/teacher/notes' },
      ]
    },
    {
      section: 'Tools',
      items: [
        ...
        { title: 'Comms Hub', icon: MessageCircle, route: '/teacher/comms' },
      ]
    },
  ],
};
