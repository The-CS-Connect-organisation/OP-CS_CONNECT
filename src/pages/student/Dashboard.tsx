            ...
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">{user?.class ? `${user.class} ΓÇó` : ''} Roll No: {user?.rollNo || 'ΓÇö'}</p>
                </div>
              </div>
                ...
                {upcomingAssignments.map((assignment) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground">{assignment.subject} ΓÇó Due: {assignment.dueDate}</p>
                    </div>
                    ...
                    <tbody>
                      {grades.map((grade: any) => (
                        <tr key={grade.subject} className="border-b border-border/30 hover:bg-secondary/20 transition-colors">
                          ...
                          <td className="py-3 px-2 text-center text-sm">{grade.midTerm || 'ΓÇö'}</td>
                          <td className="py-3 px-2 text-center text-sm">{grade.finalTerm || 'ΓÇö'}</td>
                          <td className="py-3 px-2 text-center text-sm font-semibold">{grade.overall || 'ΓÇö'}</td>
                          <td className="py-3 px-2 text-center text-sm">{grade.grade || 'ΓÇö'}</td>
