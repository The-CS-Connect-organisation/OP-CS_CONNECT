      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-4 card-hover flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xl font-bold stat-value">{formatCurrency(totalCollected)}</p>
          </div>
        </Card>
        <Card className="p-4 card-hover flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xl font-bold stat-value">{formatCurrency(totalPending)}</p>
          </div>
        </Card>
        <Card className="p-4 card-hover flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xl font-bold stat-value">{stats.defaultersCount || '--'}</p>
          </div>
        </Card>
        <Card className="p-4 card-hover flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xl font-bold stat-value">{allFees.length}</p>
          </div>
        </Card>
      </div>
