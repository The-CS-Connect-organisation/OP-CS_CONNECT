...
import { User, Mail, Phone, MapPin, Bus, Edit, Save, X, Calendar, Clock } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 bg-accent rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium">Route A</p>
                <p className="text-sm text-muted-foreground">Morning: 7:00 AM - 8:30 AM</p>
              </div>
            </div>
          </div>
          <div className="p-4 bg-accent rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium">Route A</p>
                <p className="text-sm text-muted-foreground">Afternoon: 3:00 PM - 4:30 PM</p>
              </div>
            </div>
          </div>
        </div>
