...
import { User, Mail, Phone, MapPin, Edit, Save, X, Library } from 'lucide-react';
    ...
    <div className="p-6 space-y-6">
      ...
      <Card className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-4 bg-accent rounded-lg text-center">
            <p className="text-2xl font-bold text-orange-500">980</p>
            <p className="text-sm text-muted-foreground">Available</p>
          </div>
          <div className="p-4 bg-accent rounded-lg text-center">
            <p className="text-2xl font-bold text-orange-500">270</p>
