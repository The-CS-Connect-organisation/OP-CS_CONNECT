...
import { LayoutDashboard, Users, BarChart3, Calendar, TrendingUp, AlertCircle } from 'lucide-react';
...
export default function CoordinatorDashboard() {
  ...
  const [dashboard, setDashboard] = useState({
    ...
    teacherWorkload: [] as { name: string; classes: number; students: number }[],
  });
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Academic coordination overview</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold">{dashboard.totalClasses}</p>
            ...
            <Card className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold">{dashboard.totalTeachers}</p>
            ...
            <Card className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold">{dashboard.avgAttendance}%</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="p-4">
              ...
              <div className="space-y-3">
                {dashboard.classPerformance.map(cls => (
