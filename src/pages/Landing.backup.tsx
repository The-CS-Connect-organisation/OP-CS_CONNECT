...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen h-full w-full bg-gradient-to-br from-orange-50 via-white to-amber-50 text-gray-900">
      ...
      {/* Hero Section */}
      <section className="h-screen w-full relative bg-gradient-to-br from-orange-50 via-amber-50 to-white overflow-hidden">
        {/* Grid Background */}
        ...
        {/* Gradient overlays */}
        <div className="absolute inset-0 z-[3] bg-gradient-to-t from-orange-50/80 via-transparent to-amber-50/40 pointer-events-none" />
        ...
        {/* Hero Text Content - smart-university staggered pattern */}
        <div className="absolute inset-0 z-[5] flex flex-col items-center justify-center px-4">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/40 backdrop-blur-md border border-orange-200/40 shadow-sm mb-6"
          >
            <Sparkles className="w-3.5 h-3.5 text-orange-500" />
            <span className="text-xs font-semibold text-orange-700">AI-Powered School Management</span>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-gray-500 mt-4 text-sm md:text-base max-w-xl text-center mx-auto"
          >
        ...
        {/* Stats Bar - smart-university style */}
        <div className="absolute bottom-0 left-0 right-0 z-[5]">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 1.2, duration: 0.8 }}
            className="bg-white/60 backdrop-blur-xl border-t border-orange-200/30"
          >
            <div className="max-w-4xl mx-auto grid grid-cols-3 md:grid-cols-3 divide-x divide-orange-200/30">
              {[
                { value: '10K+', label: 'Students Empowered' },
                { value: '500+', label: 'Schools Trust Us' },
                { value: '98%', label: 'Satisfaction Rate' },
              ].map((stat) => (
                <div key={stat.label} className="py-4 md:py-6 text-center px-2">
                  <p className="text-xl md:text-3xl font-bold bg-gradient-to-r from-orange-500 to-amber-500 bg-clip-text text-transparent">
                    {stat.value}
                  </p>
        ...
        {/* Explore Button */}
        <div className="absolute bottom-24 left-1/2 -translate-x-1/2 z-[6]">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
