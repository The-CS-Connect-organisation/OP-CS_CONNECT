...
const data = {
  facebookLink: 'https://facebook.com/cornerstone',
  instaLink: 'https://instagram.com/cornerstone',
  twitterLink: 'https://twitter.com/cornerstone',
  githubLink: 'https://github.com/cornerstone',
  dribbbleLink: 'https://dribbble.com/cornerstone',
  services: {
              ...
              <ul className="mt-8 space-y-4 text-sm">
                {helpfulLinks.map(({ text, href, hasIndicator }) => (
                  <li key={text}>
                    ...
                    >
                      <span className="text-secondary-foreground/70 transition hover:text-foreground">
                        {text}
                      </span>
                      {hasIndicator && (
                ...
                {contactInfo.map(({ icon: Icon, text, isAddress }) => (
                  <li key={text}>
                    ...
                    >
                      ...
                      {isAddress ? (
                        <address className="text-secondary-foreground/70 -mt-0.5 flex-1 not-italic transition hover:text-foreground">
                          {text}
                        </address>
                      ) : (
                        <span className="text-secondary-foreground/70 flex-1 transition hover:text-foreground">
                          {text}
                        </span>
                      )}
                    </a>
