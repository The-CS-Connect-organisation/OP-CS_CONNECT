      ...
      <div className="relative z-10 flex size-full flex-col justify-between p-5 text-blue-50">
        ...
        {isComingSoon && (
          <div
            ...
            onMouseLeave={handleMouseLeave}
                className="border-hsla relative flex w-fit cursor-pointer items-center gap-1 overflow-hidden rounded-full bg-black/60 px-5 py-2 text-xs uppercase text-white"
          >
            <div
...
const Features = () => (
  <section id="features" className="bg-white pb-52">
    <div className="container mx-auto px-3 md:px-10">
      <div className="px-5 py-32">
        <p className="font-circular-web text-lg text-gray-900">
          The Intelligent School Platform
        </p>
        <p className="max-w-md font-circular-web text-lg text-gray-500">
          Immerse yourself in a rich ecosystem where powerful school management
          tools converge into an interconnected intelligence layer for your institution.
        </p>
      </div>
      ...
      <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
        ...
        <BentoTilt className="bento-tilt_2">
          <div className="flex size-full flex-col justify-between bg-orange-500 p-5">
